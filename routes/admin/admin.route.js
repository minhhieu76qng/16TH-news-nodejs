...
router.post('/tag/update', (req, res, next) => {
    const UserID = req.user.id;
...
router.get('/tag/delete/:id', (req, res, next) => {
    const UserID = req.user.id;
...
router.get('/writer/is-available', (req, res, next) => {
...
router.get('/writer/ban/:id', (req, res, next) => {
    const UserID = req.user.id;
...
router.get('/editor/is-available', (req, res, next) => {
    var email = req.query.email;
...
router.get('/editor/ban/:id', (req, res, next) => {
    const UserID = req.user.id;
...
router.get('/subscriber/is-available', (req, res, next) => {
    var email = req.query.email;
